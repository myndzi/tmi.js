		...
		switch(message.command) {
			...
			case "USERNOTICE":
				...
				switch(msgid) {
					...
					// Handle standard "pay-it-forward" (gifted user gifts a sub)
					case "standardpayforward":
						this.emit("standardpayforward", channel, username, tags);
						break;

					// Handle community "pay-it-forward" (community gift recipient gifts a sub)
					case "communitypayforward":
						this.emit("communitypayforward", channel, username, tags);
						break;
